...
import TestimonyAccent from 'assets/image/img/frame-testi.png'
    ...
    return (
        ...
        <section className="container">
            ...
            <div className="col">
                ...
                <div>
                <Button className="btn font-weight-bold px-5" style={{ marginTop: 40 }} hasShadow isPrimary type="link" href={`/testimonial/${data._id}`}>
                    Read Story
                </Button>
                </div>
            </div>
